...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  React JS is a popular JS library, created for Facebook, that is used to create applications. It solves the vanilla JS problem of the DOM being difficult tto work with and manipulate when there are many different interactions and data sources.

2. Describe component state.
  Component state refers to the current data being displayed in the browser's window.

3. Describe props.
  Props are a built in, read-only object that is used to pass state from one file in an application to its child. 

4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
  Side effects affect elements outside the scope of the function being executed. Side effects can be synced to changes of state using the useEffect() hook.
